...
const variants: Record<Variant, string> = {
  ...
  accent:
    "bg-[var(--color-accent-500)] text-[var(--color-accent-ink,#1a0f00)] hover:bg-[var(--color-accent-600)] hover:text-white border border-[var(--color-accent-500)] font-semibold",
  secondary:
